      ...
      <div class="border border-solid border-netral-background p-3 rounded-b-lg">
        <div class="flex gap-x-1.5 items-center">
          ...
          <div class="text-sm text-netral-black">
            Total Penyimpanan APAR  = Penyimpanan APAR (Fixed) * 2,50% + Penyimpanan APAR (Portable) * 3,50%
          </div>
        </div>
        <div class="flex gap-x-1.5 items-center mt-2">
          ...
          <div class="text-sm text-netral-black">Jika Penggunaan APAR lebih besar, maka Penggunaan APAR / 1000. Jika Penyimapanan APAR lebih besar, maka Penyimpanan APAR / 1000</div>
        </div>
        <div class="flex gap-x-1.5 items-center mt-2">
          <div
            class="bg-netral-background px-1.5 py-1 rounded text-[10px] text-blue-main font-semibold"
          ...
          <div class="text-sm text-netral-black">Total Emisi CO2 x GWP Jenis Gas</div>
        </div>
      </div>
    </div>
  </div>
