...
import FugitiveAcKulkasTableComponent from '@/views/inventarisasi-grk/fugitive-ac-kulkas/partials/table.vue'
import { useFugitiveAcRuanganTableActions } from '@/views/inventarisasi-grk/fugitive-ac-kulkas/hooks/table.js'
import { useComboboxActions } from '@/utils/combobox.js'
import { userProfile } from '@/utils/constant.js'
import { useFugitiveAcRuanganDialogActions } from '@/views/inventarisasi-grk/fugitive-ac-kulkas/hooks/dialog.js'
import FugitiveAcKulkasDialogForm from '@/views/inventarisasi-grk/fugitive-ac-kulkas/partials/dialog-form/dialog.form.vue'
import DialogAlert from '@/components/DialogAlert.vue'
import DialogConfirmation from '@/components/DialogConfirmation.vue'
import FugitiveAcKulkasDialogDetailComponent from '@/views/inventarisasi-grk/fugitive-ac-kulkas/partials/dialog-detail/dialog.detail.vue'

defineOptions({
  name: 'InventarisasiGrkFugitiveAcKulkasPage',
})
...
onMounted(() => {
  ...
  getComboboxVariableFaktorEmisi(`jenisLaporan.namaTrx=='Fugitive AC Kulkas'`)
  getComboboxFaktorEmisiList(`jenisLaporan.namaTrx=='Fugitive AC Kulkas'`)
})
...
<template>
  <HeaderPage title="Fugitive AC Kulkas">
    <template #action>
      <AmButton type="ghost">
        <template #prepend>
    ...
    <AmTab v-model:activeTab="activeTab">
      ...
      <template #tab-content="{ activeTab }">
        <AmTabContent :isActive="activeTab === 'Semua Laporan'">
          <FugitiveAcKulkasTableComponent
            @on-detail="onDetail"
            :columns="columns"
            :data="data"
  ...
  />
  <fugitive-ac-kulkas-dialog-detail-component
