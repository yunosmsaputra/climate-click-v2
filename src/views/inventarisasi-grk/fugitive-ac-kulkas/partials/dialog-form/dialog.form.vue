...
import FugitiveAcKulkasData from '@/views/inventarisasi-grk/fugitive-ac-kulkas/partials/dialog-form/data-fugitive-ac-kulkas.vue'
import FugitiveAcRuanganHasilPerhitunganEmisi from '@/views/inventarisasi-grk/fugitive-ac-kulkas/partials/dialog-detail/hasil-perhitungan-emisi.vue'
import DataFugitiveAcRuanganDetail from '@/views/inventarisasi-grk/fugitive-ac-kulkas/partials/dialog-detail/data.vue'

defineOptions({
  name: 'FugitiveAcKulkasDialogForm',
})
  ...
  >
    <template #dialog-title>
      <div class="flex items-center">
        ...
        <div class="text-lg text-netral-label font-semibold pl-2">
          Form Laporan Fugitive AC Kulkas
        </div>
      </div>
    </template>
    <template #dialog-content>
      <div v-show="showPratinjau">
        ...
        />
        <data-fugitive-ac-ruangan-detail
          :data="params"
          class="border-t-[8px] border-t-netral-background border-solid"
        />
    ...
    <template #dialog-actions>
      <AmButton type="ghost">Simpan sebagai Draft</AmButton>
      <AmButton v-if="!showPratinjau" :is-loading="isLoadingButton">Hitung Emisi</AmButton>
      <AmButton v-if="showPratinjau">Kirim Laporan</AmButton>
    </template>
  </AmDialog>
</template>
