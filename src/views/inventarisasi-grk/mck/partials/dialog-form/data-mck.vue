...
<template>
  <div class="pt-[18px] pr-[18px] pb-6 pl-6 bg-netral-white">
    <TitleSection>Data Bahan Bakar Kendaraan</TitleSection>
      ...
      <AmFormRow class="flex gap-x-4 mt-2">
        <AmFormCol class="w-[240px]">
          ...
          <div class="text-xs leading-4 text-netral-textDisabled mt-[6px]">
            Berisi status kepemilikan Kendaraan
          </div>
        </AmFormCol>
        <AmFormCol class="w-[calc((100%-272px)/2)]">
          <AmSelectBox
            v-model="params.data_list[index].status_kepemilikan"
            placeholder="Pilih Jenis Status Kepemilikan"
            size="medium"
            rules="required"
            searchable
            :options="['Milik PLN Group', 'Sewa']"
          ></AmSelectBox>
        </AmFormCol>
      </AmFormRow>
      <AmFormRow class="flex gap-x-4">
        <AmFormCol class="w-[240px]">
          <AmFormLabel required size="medium">Bahan Bakar Kendaraan</AmFormLabel>
          <div class="text-xs leading-4 text-netral-textDisabled mt-[6px]">
            Berisi jenis bahan bakar dan jumlah konsumsi bahan bakar kendaraan
          </div>
        </AmFormCol>
        <AmFormCol class="w-[calc((100%-272px)/2)]">
          <AmSelectBox
            ...
            rules="required"
            searchable
            :options="comboboxJenisBahanbakar"
            identifier="id"
            text="nama"
          ></AmSelectBox>
        </AmFormCol>
        <AmFormCol class="w-[calc((100%-272px)/2)]">
          <AmTextField
            v-model="params.data_list[index].konsumsi_bb"
          ...
          >
            <template #append-inner>
              <div class="text-xs text-[#2671D9]">Liter</div>
            </template>
          </AmTextField>
        </AmFormCol>
      </AmFormRow>
