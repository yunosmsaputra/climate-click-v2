...
defineOptions({
  name: 'FugitiveAcKendaraanHasilPerhitunganEmisi',
})
      ...
      <div class="border border-solid border-netral-background p-3 rounded-b-lg">
        <div class="flex gap-x-1.5 items-center">
          ...
          <div class="text-sm text-netral-black">
            Total Kapasitas Refrigerant Kendaraan x GWP Jenis Refrigerant x Operating Emissions X (%
            of capacity) dari Jenis AC
          </div>
        </div>
