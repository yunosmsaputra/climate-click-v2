...
<template>
  <div class="pt-[18px] pr-[18px] pb-6 pl-6 bg-netral-white">
    <TitleSection>Data Fugitive AC Ruangan</TitleSection>
    <div class="mt-4" v-for="(item, index) in params.data_list" :key="index">
      ...
      <AmFormRow class="flex gap-x-4 mt-2">
        <AmFormCol class="w-[240px]">
          <AmFormLabel required size="medium">Jenis AC</AmFormLabel>
          <div class="text-xs leading-4 text-netral-textDisabled mt-[6px]">
            Berisi jenis ac yang digunakan
          </div>
        </AmFormCol>
        <AmFormCol class="w-[calc((100%-272px)/2)]">
          <AmSelectBox
            v-model="params.data_list[index].variabel_faktor_emisi"
            placeholder="Pilih Jenis AC"
            size="medium"
            rules="required"
            searchable
            :options="comboboxJenisAc"
            identifier="id"
            text="nama"
          ></AmSelectBox>
        </AmFormCol>
      ...
      <AmFormRow class="flex gap-x-4">
        <AmFormCol class="w-[240px]">
          <AmFormLabel required size="medium">Penggunaan Refrigerant</AmFormLabel>
          <div class="text-xs leading-4 text-netral-textDisabled mt-[6px]">
            Berisi jenis dan jumlah refrigerant yang digunakan
          </div>
        </AmFormCol>
        <AmFormCol class="w-[calc((100%-272px)/2)]">
          <AmSelectBox
            v-model="params.data_list[index].faktor_emisi"
            placeholder="Pilih Jenis Refigerant"
            size="medium"
            rules="required"
            searchable
        ...
        <AmFormCol class="w-[calc((100%-272px)/2)]">
          <AmTextField
            ...
            placeholder="Jumlah Penggunaan Refrigerant"
            size="medium"
