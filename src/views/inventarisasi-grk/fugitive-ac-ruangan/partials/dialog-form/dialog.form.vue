...
import FugitiveAcRuanganData from '@/views/inventarisasi-grk/fugitive-ac-ruangan/partials/dialog-form/data-fugitive-ac-ruangan.vue'
import FugitiveAcRuanganHasilPerhitunganEmisi from '@/views/inventarisasi-grk/fugitive-ac-ruangan/partials/dialog-detail/hasil-perhitungan-emisi.vue'
import DataFugitiveAcRuanganDetail from '@/views/inventarisasi-grk/fugitive-ac-ruangan/partials/dialog-detail/data.vue'

defineOptions({
  name: 'FugitiveAcRuanganDialogForm',
})
