...
export const useFugitiveAcRuanganDialogActions = () => {
  ...
  const openDialogForm = (idEditData = null) => {
    ...
    if (idEditData) {
      ...
      callApi({
        config: {
          url: `${host.grk}/api/v2/fugitive-ac-ruangan/detail`,
          method: 'GET',
          params: {
            id: idEditData,
          },
    ...
    if (refForm.value.validate()) {
      ...
      callApi({
        ...
        onSuccess: (response) => {
          ...
          callApi({
            config: {
              url: `${host.grk}/api/v2/fugitive-ac-ruangan/preview-hitung`,
              method: 'POST',
              data: {
            ...
            onSuccess: (resp) => {
              ...
              if (file) {
                ...
                paramsForm.value = {
                  ...
                  data_list: resp.data.data.data_list.map((item) => ({
                    ...item,
                    faktor_emisi: { id: item.id_faktor_emisi, nama: item.nama_faktor_emisi },
                    variabel_faktor_emisi: {
                      id: item.id_variabel_faktor_emisi,
                  ...
                  periode: { month: resp.data.data.bulan, year: resp.data.data.tahun },
                }
  ...
  const onSaveData = (filePath = null) => {
    const dataList = paramsForm.value.data_list.map((item) => ({
      ...
      id_faktor_emisi: item.faktor_emisi?.id ? item.faktor_emisi.id : (item.idFaktorEmisi ?? null),
      id_variabel_faktor_emisi: item.variabel_faktor_emisi?.id
        ? item.variabel_faktor_emisi.id
        : (item.idVariabelFaktorEmisi ?? null),
    }))
    loadingButton.value = true
    callApi({
      config: {
        url: `${host.grk}/api/v2/fugitive-ac-ruangan/save`,
        method: 'POST',
        data: {
          id_unit: paramsForm.value.isUnitLaporanSendiri
            ? userProfile.unit.id
  ...
  const getRiwayatData = (data) => {
    ...
    callApi({
      config: {
        url: `${host.grk}/api/v2/fugitive-ac-ruangan/history`,
        method: 'GET',
        params: {
          id: data.id,
        },
  ...
  const sendLaporan = (fileUrl = null) => {
    ...
    callApi({
      config: {
        url: `${host.grk}/api/v2/fugitive-ac-ruangan/kirim`,
        method: 'POST',
        data: {
          ...(paramsForm.value.id && { id: paramsForm.value.id }),
          id_unit: userProfile.unit.id,
  ...
  const approveLaporan = () => {
    ...
    callApi({
      config: {
        url: `${host.grk}/api/v2/fugitive-ac-ruangan/approve-ui-sh`,
        method: 'POST',
        data: {
  ...
  const deleteData = () => {
    ...
    callApi({
      config: {
        url: `${host.grk}/api/v2/fugitive-ac-ruangan/delete`,
        method: 'POST',
        data: {
          id: paramsForm.value.id,
        },
  ...
  const rejectLaporan = () => {
    ...
    callApi({
      config: {
        url: `${host.grk}/api/v2/fugitive-ac-ruangan/tolak-ui-sh`,
        method: 'POST',
        data: {
          id: paramsForm.value.id,
  ...
  const revisiLaporan = () => {
    ...
    callApi({
      config: {
        url: `${host.grk}/api/v2/fugitive-ac-ruangan/revisi-divtek`,
        method: 'POST',
        data: {
          id: paramsForm.value.id,
          keterangan_tolak: keteranganPenolakan.value,
